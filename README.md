...
- **2026.02.12**: 🔥 Releasing openocr-python 0.1.4: Support the PDF file as an input; Parallel recognition of document elements; Add [skill](https://clawhub.ai/Topdu/openocr-skill) for OpenClaw Agent. Accessible in [Doc](./QUICKSTART.md).
