...
class RobustScannerLabelDecode(BaseRecLabelDecode):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(RobustScannerLabelDecode, self).__init__(character_dict_path,
                                                       use_space_char)
    ...
    def __call__(self, preds, batch=None, *args, **kwargs):
        ...
        label = self.decode(label[:, 1:], is_remove_duplicate=False)
        return text, label
