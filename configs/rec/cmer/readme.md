...
**MER-17M** is a large-scale dataset emphasizing the recognition of complex mathematical expressions, providing rich and diverse samples to support the development of accurate MER models.

- **Download Link**: [Hugging Face - MER-17M](https://huggingface.co/datasets/topdu/MER-17M)
